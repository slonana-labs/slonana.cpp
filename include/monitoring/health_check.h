...
public:
     ...
     */
    std::optional<HealthCheckResult> check_component(const std::string& component_name);
     ...
     */
    std::vector<HealthCheckResult> get_component_history(
...
private:
    ...
    HealthStatus calculate_overall_status(const std::vector<HealthCheckResult>& results);
...
public:
    ...
    std::chrono::milliseconds get_timeout() const override { return std::chrono::milliseconds{5000}; }
...
public:
    ...
    std::chrono::milliseconds get_timeout() const override { return std::chrono::milliseconds{3000}; }
...
public:
    ...
    std::chrono::milliseconds get_timeout() const override { return std::chrono::milliseconds{1000}; }
...
public:
    ...
    std::chrono::milliseconds get_timeout() const override { return std::chrono::milliseconds{2000}; }
};
