...
public:
   ...
   */
  bool send_message_to_peer(const NetworkPeer &peer,
...
private:
   ...
   */
  void update_peer_transmission_stats(const NetworkPeer &peer,
                                      size_t bytes_sent,
                                      int64_t transmission_time_ms);
...
public:
  ...
  get_entrypoints_for_network(const std::string &network_id);
};
