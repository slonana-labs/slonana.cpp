...
public:
  ...
  HttpResponse solana_rpc_call(const std::string &rpc_url,
...
private:
  ...
  // Helper methods
  HttpResponse
  execute_request(const std::string &url, const std::string &method,
                  const std::string &data = "",
                  const std::map<std::string, std::string> &headers = {});
  std::string escape_url(const std::string &url);
  std::string
  build_header_string(const std::map<std::string, std::string> &headers);
};
