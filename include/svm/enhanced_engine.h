...
private:
    ...
    ExecutionOutcome handle_initialize_mint(
        const Instruction& instruction,
        ExecutionContext& context
    ) const;

    ExecutionOutcome handle_initialize_account(
        const Instruction& instruction,
        ExecutionContext& context
    ) const;

    ExecutionOutcome handle_transfer(
        const Instruction& instruction,
        ExecutionContext& context
    ) const;

    ExecutionOutcome handle_mint_to(
        const Instruction& instruction,
        ExecutionContext& context
    ) const;

    ExecutionOutcome handle_burn(
        const Instruction& instruction,
        ExecutionContext& context
    ) const;
