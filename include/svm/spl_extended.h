...
public:
  ...
  execute_instruction(const std::vector<uint8_t> &instruction_data,
                      const std::vector<AccountInfo> &accounts);

private:
  static ExecutionResult
  initialize_mint(const std::vector<uint8_t> &data,
                  const std::vector<AccountInfo> &accounts);
  static ExecutionResult
  initialize_account(const std::vector<uint8_t> &data,
                     const std::vector<AccountInfo> &accounts);
  static ExecutionResult transfer(const std::vector<uint8_t> &data,
                                  const std::vector<AccountInfo> &accounts);
  static ExecutionResult approve(const std::vector<uint8_t> &data,
                                 const std::vector<AccountInfo> &accounts);
  static ExecutionResult mint_to(const std::vector<uint8_t> &data,
                                 const std::vector<AccountInfo> &accounts);
  static ExecutionResult burn(const std::vector<uint8_t> &data,
                              const std::vector<AccountInfo> &accounts);
  static ExecutionResult
  transfer_checked(const std::vector<uint8_t> &data,
                   const std::vector<AccountInfo> &accounts);

  static bool verify_mint_authority(const std::string &mint_account,
                                    const std::string &authority);
  static bool verify_token_owner(const std::string &token_account,
                                 const std::string &owner);
  static uint64_t get_token_balance(const std::string &token_account);
  static void update_token_balance(const std::string &token_account,
...
public:
  ...
  enum class Instruction { CREATE, CREATE_IDEMPOTENT, RECOVER_NESTED };
  ...
  static std::string
  derive_associated_token_address(const std::string &wallet_address,
                                  const std::string &token_mint_address);

private:
  static ExecutionResult
  create_associated_token_account(const std::vector<AccountInfo> &accounts,
                                  bool idempotent = false);

  static ExecutionResult
  recover_nested_account(const std::vector<AccountInfo> &accounts);
};
...
public:
  ...
  static bool validate_signers(const std::vector<std::string> &signers,
                               const std::vector<AccountInfo> &accounts);
...
public:
  ...
  static std::string derive_name_account_key(const std::string &name,
                                             const std::string &name_class,
                                             const std::string &parent_name);

private:
  static ExecutionResult
  create_name_registry(const std::vector<uint8_t> &data,
                       const std::vector<AccountInfo> &accounts);
  static ExecutionResult
  update_name_registry(const std::vector<uint8_t> &data,
                       const std::vector<AccountInfo> &accounts);
  static ExecutionResult
  transfer_ownership(const std::vector<uint8_t> &data,
                     const std::vector<AccountInfo> &accounts);
  static ExecutionResult
  delete_name_registry(const std::vector<uint8_t> &data,
                       const std::vector<AccountInfo> &accounts);

  static bool verify_name_ownership(const std::string &name_account,
                                    const std::string &owner);
};
...
private:
  static ExecutionResult
  create_metadata_account(const std::vector<uint8_t> &data,
                          const std::vector<AccountInfo> &accounts);
  static ExecutionResult
  update_metadata_account(const std::vector<uint8_t> &data,
                          const std::vector<AccountInfo> &accounts);
  static ExecutionResult
  create_master_edition(const std::vector<uint8_t> &data,
                        const std::vector<AccountInfo> &accounts);
  static ExecutionResult
  verify_collection(const std::vector<uint8_t> &data,
                    const std::vector<AccountInfo> &accounts);
...
private:
  std::unordered_map<std::string, std::function<ExecutionResult(
...
public:
  ...
  ExecutionResult
  execute_spl_program(const std::string &program_id,
...
// Error handling
ExecutionResult create_program_error(const std::string &message,
