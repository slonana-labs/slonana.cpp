 ...
 */
using DeviceCallback = std::function<void(const DeviceInfo&, ConnectionStatus)>;
...
public:
     ...
     */
    virtual std::vector<uint8_t> get_public_key(const std::string& derivation_path) = 0;
     ...
     */
    virtual SigningResponse sign_transaction(
