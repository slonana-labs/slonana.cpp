...
public:
   ...
   */
  static HardwareWalletConfig
  merge_configs(const HardwareWalletConfig &base,
   ...
   */
  static std::optional<DeviceConfig>
  get_device_config(const HardwareWalletConfig &config,
   ...
   */
  static void set_device_config(HardwareWalletConfig &config,
   ...
   */
  static bool remove_device_config(HardwareWalletConfig &config,
                                   const std::string &device_id);
};
