...
int main() {
    ...
    try {
        ...
        std::cout << "   • Cross-Region Links: " << cross_region_links.size() << std::endl;
        
        auto backend_servers = load_balancer->get_backend_servers();
        std::cout << "   • Backend Servers: " << backend_servers.size() << std::endl;
        ...
        for (const auto& partition : partitions) {
            std::cout << "   • " << partition.partition_id << ": " << partition.node_ids.size() 
                      << " nodes (" << (partition.is_healthy ? "healthy" : "unhealthy") << ")" << std::endl;
        }
        ...
        std::cout << "   ✅ Cross-Master Coordination and Service Discovery" << std::endl;
        std::cout << "   ✅ Cross-Region Network Links and Request Routing" << std::endl;
        std::cout << "   ✅ Performance-Aware Load Distribution" << std::endl;
        std::cout << "   ✅ Production-Ready Multi-Master Network Infrastructure" << std::endl;
