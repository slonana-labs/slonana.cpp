...
void TransactionErrorMetrics::reset() { *this = TransactionErrorMetrics{}; }
...
void TransactionErrorMetrics::add(const TransactionErrorMetrics &other) {
  ...
  would_exceed_max_account_data_cost_limit +=
      other.would_exceed_max_account_data_cost_limit;
  would_exceed_account_data_block_limit +=
      other.would_exceed_account_data_block_limit;
  would_exceed_account_data_total_limit +=
      other.would_exceed_account_data_total_limit;
...
double
TransactionErrorMetrics::get_error_rate(uint64_t total_transactions) const {
...
TransactionErrorMetrics::export_metrics() const {
  return {
...
bool is_recoverable_error(const std::string &error_type) {
  ...
  return error_type == "blockhash_too_old" || error_type == "account_in_use" ||
