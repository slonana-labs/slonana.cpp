...
private:
    ...
    bool test_banking_stage_parallel_processing() {
        ...
        std::cout << "✅ Banking stage parallel processing test passed" << std::endl;
        return true;
    }
    ...
    bool test_banking_stage_resource_monitoring() {
        ...
        std::cout << "✅ Banking stage resource monitoring test passed" << std::endl;
        return true;
    }
    ...
    bool test_validator_core_integration() {
        ...
        common::PublicKey validator_id = {'t','e','s','t','_','v','a','l','i','d','a','t','o','r'};
        ...
        if (!start_result.is_ok()) {
            std::cout << "Failed to start validator core: " << start_result.error() << std::endl;
            return false;
        }
    ...
    bool test_end_to_end_workflow() {
        ...
        if (!start_result.is_ok()) {
            std::cout << "Failed to start validator: " << start_result.error() << std::endl;
            return false;
        }
