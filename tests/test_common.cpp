...
void run_common_tests(TestRunner& runner) {
    ...
    runner.run_test("Result Type Move Semantics", test_result_type_move_semantics);
    runner.run_test("Result Type Copy Semantics", test_result_type_copy_semantics);
    runner.run_test("Validator Config Default Values", test_validator_config_default_values);
    runner.run_test("Validator Config Custom Values", test_validator_config_custom_values);
    runner.run_test("Validator Stats Initialization", test_validator_stats_initialization);
