...
public:
  static void run_all_tests() {
    ...
    std::cout << "All hardware wallet tests completed successfully!"
              << std::endl;
  }
...
private:
  ...
  static void test_ledger_initialization_and_discovery() {
    ...
    ledger->shutdown();
    std::cout << "✓ Ledger initialization and discovery test passed"
              << std::endl;
  }
  ...
  static void test_trezor_initialization_and_discovery() {
    ...
    trezor->shutdown();
    std::cout << "✓ Trezor initialization and discovery test passed"
              << std::endl;
  }
  ...
  static void test_device_callbacks() {
    ...
    ledger->register_callback(
        [&](const DeviceInfo &info, ConnectionStatus status) {
  ...
  static void test_utility_functions() {
    ...
    assert(device_type_to_string(DeviceType::TREZOR_MODEL_T) ==
           "Trezor Model T");
    ...
    assert(signing_result_to_string(SigningResult::USER_CANCELLED) ==
           "User Cancelled");
  ...
  static void test_derivation_path_validation() {
    ...
    std::vector<std::string> valid_paths = {"m/44'/501'/0'/0'", "m/44'/501'/1'",
                                            "m/44'/501'/0'/0'/0'", "m/0/1/2/3"};
