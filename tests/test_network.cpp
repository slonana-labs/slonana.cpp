...
void test_rpc_get_health() {
    ...
    std::string request = R"({"jsonrpc":"2.0","method":"getHealth","params":"","id":"1"})";
...
void test_rpc_get_version() {
    ...
    std::string request = R"({"jsonrpc":"2.0","method":"getVersion","params":"","id":"2"})";
    std::string response = rpc_server.handle_request(request);
...
void test_rpc_get_slot() {
    ...
    std::string request = R"({"jsonrpc":"2.0","method":"getSlot","params":"","id":"3"})";
    std::string response = rpc_server.handle_request(request);
...
void test_rpc_get_account_info() {
    ...
    std::string request = R"({"jsonrpc":"2.0","method":"getAccountInfo","params":["11111111111111111111111111111112"],"id":"4"})";
    std::string response = rpc_server.handle_request(request);
...
void test_rpc_get_balance() {
    ...
    std::string request = R"({"jsonrpc":"2.0","method":"getBalance","params":["11111111111111111111111111111112"],"id":"5"})";
    std::string response = rpc_server.handle_request(request);
...
void test_rpc_get_block_height() {
    ...
    std::string request = R"({"jsonrpc":"2.0","method":"getBlockHeight","params":"","id":"6"})";
    std::string response = rpc_server.handle_request(request);
...
void test_rpc_get_genesis_hash() {
    ...
    std::string request = R"({"jsonrpc":"2.0","method":"getGenesisHash","params":"","id":"7"})";
    std::string response = rpc_server.handle_request(request);
...
void test_rpc_get_identity() {
    ...
    std::string request = R"({"jsonrpc":"2.0","method":"getIdentity","params":"","id":"8"})";
    std::string response = rpc_server.handle_request(request);
...
void test_rpc_get_epoch_info() {
    ...
    std::string request = R"({"jsonrpc":"2.0","method":"getEpochInfo","params":"","id":"9"})";
    std::string response = rpc_server.handle_request(request);
...
void test_rpc_unknown_method() {
    ...
    std::string request = R"({"jsonrpc":"2.0","method":"unknownMethod","params":"","id":"10"})";
    std::string response = rpc_server.handle_request(request);
...
void run_network_tests(TestRunner& runner) {
    ...
    runner.run_test("Gossip Protocol Initialization", test_gossip_protocol_initialization);
    runner.run_test("Gossip Protocol Start/Stop", test_gossip_protocol_start_stop);
    runner.run_test("Gossip Message Broadcasting", test_gossip_message_broadcasting);
}