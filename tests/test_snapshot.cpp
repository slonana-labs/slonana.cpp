...
void test_auto_snapshot_service() {
    ...
    std::cout << "Created " << snapshots.size() << " snapshots automatically" << std::endl;
    std::cout << "PASSED (0ms)" << std::endl;
}
...
int main() {
    ...
    std::cout << "- ✅ Auto snapshot service with background operation" << std::endl;
    std::cout << "- ✅ Snapshot streaming for validator synchronization" << std::endl;
